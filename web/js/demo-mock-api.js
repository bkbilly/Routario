...
(() => {
    ...
    const demoSystemSettingsCategories = {
        ...
        'VoIP & SIP Voice Calls': [
            ...
            { key: 'voip_tts_engine', label: 'TTS Engine', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Text-to-speech generation engine for voice alarms', secret: false, readonly: false, value: 'gtts', has_value: true, options: ['gtts', 'espeak', 'gemini'] },
            { key: 'voip_gtts_language', label: 'gTTS Language', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Voice language for Google Translate TTS synthesis', secret: false, readonly: false, value: 'en', has_value: true, options: [
                { value: 'af', label: 'Afrikaans' }, { value: 'sq', label: 'Albanian' }, { value: 'am', label: 'Amharic' }, { value: 'ar', label: 'Arabic' },
                { value: 'eu', label: 'Basque' }, { value: 'bn', label: 'Bengali' }, { value: 'bs', label: 'Bosnian' }, { value: 'bg', label: 'Bulgarian' },
                { value: 'yue', label: 'Cantonese' }, { value: 'ca', label: 'Catalan' }, { value: 'zh-CN', label: 'Chinese (Simplified)' }, { value: 'zh-TW', label: 'Chinese (Traditional)' },
                { value: 'hr', label: 'Croatian' }, { value: 'cs', label: 'Czech' }, { value: 'da', label: 'Danish' }, { value: 'nl', label: 'Dutch' },
                { value: 'en', label: 'English' }, { value: 'et', label: 'Estonian' }, { value: 'tl', label: 'Filipino' }, { value: 'fi', label: 'Finnish' },
                { value: 'fr', label: 'French' }, { value: 'fr-CA', label: 'French (Canada)' }, { value: 'gl', label: 'Galician' }, { value: 'de', label: 'German' },
                { value: 'el', label: 'Greek' }, { value: 'gu', label: 'Gujarati' }, { value: 'ha', label: 'Hausa' }, { value: 'iw', label: 'Hebrew' },
                { value: 'hi', label: 'Hindi' }, { value: 'hu', label: 'Hungarian' }, { value: 'is', label: 'Icelandic' }, { value: 'id', label: 'Indonesian' },
                { value: 'it', label: 'Italian' }, { value: 'ja', label: 'Japanese' }, { value: 'jw', label: 'Javanese' }, { value: 'kn', label: 'Kannada' },
                { value: 'km', label: 'Khmer' }, { value: 'ko', label: 'Korean' }, { value: 'la', label: 'Latin' }, { value: 'lv', label: 'Latvian' },
                { value: 'lt', label: 'Lithuanian' }, { value: 'ms', label: 'Malay' }, { value: 'ml', label: 'Malayalam' }, { value: 'mr', label: 'Marathi' },
                { value: 'my', label: 'Myanmar (Burmese)' }, { value: 'ne', label: 'Nepali' }, { value: 'no', label: 'Norwegian' }, { value: 'pl', label: 'Polish' },
                { value: 'pt', label: 'Portuguese (Brazil)' }, { value: 'pt-PT', label: 'Portuguese (Portugal)' }, { value: 'pa', label: 'Punjabi (Gurmukhi)' },
                { value: 'ro', label: 'Romanian' }, { value: 'ru', label: 'Russian' }, { value: 'sr', label: 'Serbian' }, { value: 'si', label: 'Sinhala' },
                { value: 'sk', label: 'Slovak' }, { value: 'es', label: 'Spanish' }, { value: 'su', label: 'Sundanese' }, { value: 'sw', label: 'Swahili' },
                { value: 'sv', label: 'Swedish' }, { value: 'ta', label: 'Tamil' }, { value: 'te', label: 'Telugu' }, { value: 'th', label: 'Thai' },
                { value: 'tr', label: 'Turkish' }, { value: 'uk', label: 'Ukrainian' }, { value: 'ur', label: 'Urdu' }, { value: 'vi', label: 'Vietnamese' }, { value: 'cy', label: 'Welsh' }
            ]},
            { key: 'voip_espeak_voice', label: 'eSpeak Voice / Language', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Voice language variant for eSpeak synthesis', secret: false, readonly: false, value: 'en', has_value: true, options: [
                { value: 'af', label: 'Afrikaans' }, { value: 'sq', label: 'Albanian' }, { value: 'am', label: 'Amharic' }, { value: 'ar', label: 'Arabic' },
                { value: 'hy', label: 'Armenian' }, { value: 'az', label: 'Azerbaijani' }, { value: 'eu', label: 'Basque' }, { value: 'bn', label: 'Bengali' },
                { value: 'bs', label: 'Bosnian' }, { value: 'bg', label: 'Bulgarian' }, { value: 'my', label: 'Burmese' }, { value: 'ca', label: 'Catalan' },
                { value: 'zh', label: 'Chinese (Mandarin)' }, { value: 'zh-yue', label: 'Chinese (Cantonese)' }, { value: 'hr', label: 'Croatian' }, { value: 'cs', label: 'Czech' },
                { value: 'da', label: 'Danish' }, { value: 'nl', label: 'Dutch' }, { value: 'en', label: 'English (Default)' }, { value: 'en-us', label: 'English (US)' },
                { value: 'en-uk', label: 'English (UK)' }, { value: 'en-sc', label: 'English (Scotland)' }, { value: 'eo', label: 'Esperanto' }, { value: 'et', label: 'Estonian' },
                { value: 'tl', label: 'Filipino' }, { value: 'fi', label: 'Finnish' }, { value: 'fr', label: 'French' }, { value: 'fr-be', label: 'French (Belgium)' },
                { value: 'gl', label: 'Galician' }, { value: 'ka', label: 'Georgian' }, { value: 'de', label: 'German' }, { value: 'el', label: 'Greek' },
                { value: 'gu', label: 'Gujarati' }, { value: 'ha', label: 'Hausa' }, { value: 'he', label: 'Hebrew' }, { value: 'hi', label: 'Hindi' },
                { value: 'hu', label: 'Hungarian' }, { value: 'is', label: 'Icelandic' }, { value: 'id', label: 'Indonesian' }, { value: 'ga', label: 'Irish' },
                { value: 'it', label: 'Italian' }, { value: 'ja', label: 'Japanese' }, { value: 'kn', label: 'Kannada' }, { value: 'kk', label: 'Kazakh' },
                { value: 'ko', label: 'Korean' }, { value: 'la', label: 'Latin' }, { value: 'lv', label: 'Latvian' }, { value: 'lt', label: 'Lithuanian' },
                { value: 'ms', label: 'Malay' }, { value: 'ml', label: 'Malayalam' }, { value: 'mr', label: 'Marathi' }, { value: 'ne', label: 'Nepali' },
                { value: 'no', label: 'Norwegian' }, { value: 'fa', label: 'Persian (Farsi)' }, { value: 'pl', label: 'Polish' }, { value: 'pt', label: 'Portuguese (Brazil)' },
                { value: 'pt-pt', label: 'Portuguese (Portugal)' }, { value: 'pa', label: 'Punjabi' }, { value: 'ro', label: 'Romanian' }, { value: 'ru', label: 'Russian' },
                { value: 'sr', label: 'Serbian' }, { value: 'si', label: 'Sinhala' }, { value: 'sk', label: 'Slovak' }, { value: 'es', label: 'Spanish' },
                { value: 'es-la', label: 'Spanish (Latin America)' }, { value: 'sw', label: 'Swahili' }, { value: 'sv', label: 'Swedish' }, { value: 'ta', label: 'Tamil' },
                { value: 'te', label: 'Telugu' }, { value: 'th', label: 'Thai' }, { value: 'tr', label: 'Turkish' }, { value: 'uk', label: 'Ukrainian' },
                { value: 'ur', label: 'Urdu' }, { value: 'uz', label: 'Uzbek' }, { value: 'vi', label: 'Vietnamese' }, { value: 'cy', label: 'Welsh' }
            ]},
            { key: 'voip_espeak_speed', label: 'eSpeak Speech Speed (WPM)', type: 'int', category: 'VoIP & SIP Voice Calls', description: 'Speech speed in words per minute', secret: false, readonly: false, value: 150, has_value: true },
            { key: 'voip_espeak_pitch', label: 'eSpeak Voice Pitch', type: 'int', category: 'VoIP & SIP Voice Calls', description: 'Voice pitch level', secret: false, readonly: false, value: 50, has_value: true },
            { key: 'voip_gemini_api_key', label: 'Gemini API Key (Optional)', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Leave blank to use the platform Gemini key', secret: true, readonly: false, value: '', has_value: true },
            { key: 'voip_gemini_model', label: 'Gemini Audio Model', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Google Gemini Text-to-Speech audio model', secret: false, readonly: false, value: 'gemini-2.5-flash-preview-tts', has_value: true, options: ['gemini-2.5-flash-preview-tts', 'gemini-3.1-flash-tts-preview', 'gemini-2.5-pro-preview-tts'] },
            { key: 'voip_gemini_voice', label: 'Gemini Neural Voice', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Persona and timbre for voice alarms', secret: false, readonly: false, value: 'Aoede', has_value: true, options: ['Aoede', 'Puck', 'Charon', 'Kore', 'Fenrir'] },
            { key: 'voip_gemini_language', label: 'Gemini Voice Language', type: 'str', category: 'VoIP & SIP Voice Calls', description: 'Voice language for synthesis (alerts will be automatically translated if not in English)', secret: false, readonly: false, value: 'en', has_value: true, options: [
            ...
            { key: 'voip_tts_cache_retention_days', label: 'TTS Cache Retention (Days)', type: 'int', category: 'VoIP & SIP Voice Calls', description: 'Days to keep cached TTS audio files in uploads/tts (0 to disable auto-purge)', secret: false, readonly: false, value: 30, has_value: true }
        ],
