...
class FuelLog(Base):
    ...
    trip_distance_km: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
...
class ScheduledReport(Base):
    ...
    report_options:     Mapped[Optional[dict]] = mapped_column("options", JsonType, nullable=True, default=dict)
    notification_channels: Mapped[Optional[list]] = mapped_column(JsonType, nullable=True, default=list)
    attach_results:     Mapped[bool]          = mapped_column(Boolean, default=True)
