...
def _compile_and_load_protos():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if ret != 0:
            raise RuntimeError('Failed to compile Google Find Hub proto files')
        sys.path.insert(0, tmp_dir)
        try:
            import common_pb2 as _c
            import device_update_pb2 as _du
        finally:
            sys.path.pop(0)
    return _c, _du


_common_pb2, _du_pb2 = _compile_and_load_protos()

DeviceUpdate         = _du_pb2.DeviceUpdate
DevicesList          = _du_pb2.DevicesList
DevicesListRequest   = _du_pb2.DevicesListRequest
ExecuteActionRequest = _du_pb2.ExecuteActionRequest
Location             = _du_pb2.Location
DeviceType           = _du_pb2.DeviceType
SpotContributorType  = _du_pb2.SpotContributorType
IDENTIFIER_ANDROID   = _du_pb2.IDENTIFIER_ANDROID
