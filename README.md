...
| 📊 | **Fleet reports** — summary, trips, daily aggregates, alerts, logbook, geofences, scheduled reports, and CSV export per report type | |
...
| 🧭 | **Route planning** — create multi-stop planned routes, assign vehicles and drivers, preview route geometry, and track route status | |
| 💳 | **Billing operations** — company billing settings, usage tracking, plans, invoice generation, audit logs, and health checks | |
...
| 🔐 | **Security controls** — scoped API keys, authenticator-app MFA, per-permission settings access, and company-isolated admin tools | |
